...
* [Daily Console - Stage1 Bluemix Compute](https://dev-console.stage1.ng.bluemix.net/dashboard/compute)
...
* [![Deploy To Bluemix](https://bluemix.net/deploy/button.png)](https://github.com/skaegi/simple-toolchain) Simple Toolchain
